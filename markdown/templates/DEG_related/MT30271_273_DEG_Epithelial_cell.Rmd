...
### Epithelial cell & Responder & CTL vs TAK
...
filter_data <- data.frame(
  ...
  filter1_selection = 'Epithelial cell',
  filter2 = 'res',
  filter2_selection = 'R',
  filter3 = 'sample',
...
data.frame("UP-regulated genes" = (DEG.out %>% 
                                     ...
                                     pull() %>% 
                                     paste0(collapse = ',')),
           row.names = 'Epithelial cell') %>% DT::datatable(options = list(scrollX=T))
```
...
### Epithelial cell & Responder & CTL vs COM
...
### Epithelial cell & Non Responder & CTL vs TAK
...
### Epithelial cell & Non Responder & CTL vs COM
