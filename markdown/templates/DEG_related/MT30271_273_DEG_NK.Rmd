...
data.frame("UP-regulated genes" = (DEG.out %>% 
                                     ...
                                     pull() %>% 
                                     paste0(collapse = ',')),
           row.names = 'NK') %>% DT::datatable(options = list(scrollX=T))
```
