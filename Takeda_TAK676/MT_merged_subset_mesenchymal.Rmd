---
title: "Takeda Mesenchymal cells from Merged dataset"
...
This is a report for mesenchymal cell subset from merged dataset.
...
cat("\n")
cat("The dataset here is ", celltypes_to_subset[2], "\n")
...
obj.srt= readRDS(file.path(dir, paste0("rds/obj.MT_merged.3_conditions.", celltypes_to_subset[2], ".rds")))
```
...
obj.srt %>% saveRDS(file.path(dir, paste0("rds/obj.MT_merged.3_conditions.", celltypes_to_subset[2], ".rds")))
```
...
for (resolution_number in resolution_values) {
  ...
  output_file = paste0(dir,"data/mks/Takeda_", celltypes_to_subset[2],"_",res, ".markers.csv")
...
res= paste0("RNA_snn_res.", resolution_number)
res
mks = read.csv(paste0(dir,"data/mks/Takeda_", celltypes_to_subset[2],"_",res, ".markers.csv"), row.names = 1)
