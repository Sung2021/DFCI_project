...
obj.srt %>% saveRDS(paste0(dir,('rds/MN1_MN2_subset.500.50000.25.singlet.23.09.14.rds')))
```
...
dir= '~/Desktop/DF/DFCI_Barbie/DFCI_Barbie_NK_Marco/'
## import data
obj.srt = readRDS(paste0(dir,('rds/MN1_MN2_subset.500.50000.25.singlet.23.09.14.rds')))
```
...
### What is the best resolution for clustering for your purpose?   

The best resolution for clustering is : 
...
## Identification of marker genes based on clustering 

Marker gene information (download)   


## Assigning a cell type to each cluster  

Geneset to assign cell types 


### HUVEC 
Genes for HUVEC annotation are : 


### Fibroblast  
Genes for Fibroblast annotation are : 


#### SCLC_line   
Genes for SCLC_line annotation are : 


#### NK   
Genes for NK annotation are : 



### Monocyte 
Genes for Monocyte annotation are : 
