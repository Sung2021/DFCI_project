---
title: "NK project: UMI 500~ 50000 MN1~MN4 HUVEC"
...
This is the initial analysis report of of HUVEC cells analysis from MN1~MN4 merged dataset.
...
## import data
obj.srt = readRDS(paste0(dir,('rds/MN1_MN4_subset.500.50000.25.singlet_HUVEConly.23.10.23.rds')))
```
...
data <- data.frame(
  ...
  Cell_type = c("HUVEC", "HUVEC", "HUVEC", "HUVEC"),
  cGAMP = c("N", "Y", "N", "Y")
)
...
for (resolution_number in resolution_values) {
  ...
  output_file = paste0(dir,"data/UMI500_50000/MN1_MN4_HUVEC_", res, ".markers.csv")
...
```{r}
mks_set= "data/UMI500_50000/MN1_MN4_HUVEC_"
```
