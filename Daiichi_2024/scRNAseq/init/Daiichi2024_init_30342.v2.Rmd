...
counts_combined <- cbind(
  GetAssayData(obj_merged, assay = "RNA", layer = "counts.P30342_M"),
  GetAssayData(obj_merged, assay = "RNA", layer = "counts.P30342_I"),
  GetAssayData(obj_merged, assay = "RNA", layer = "counts.P30342_A"),
  GetAssayData(obj_merged, assay = "RNA", layer = "counts.P30342_D")
)
...
file_prefix <- 'P30342'
write_count_matrix_csv(obj.srt=obj_merged, out_directory, file_name_prefix = file_prefix)
```


```{r, eval=FALSE}
## import scrublet result
df= read.csv(paste0(dir,"P30342.count.mtx.scr.csv"), row.names = 1)
...
obj_merged %>% saveRDS(paste0(dir,"/P30342.init.24.05.06.rds"))
```
